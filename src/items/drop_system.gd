...
const RARITY_WEIGHTS: Dictionary = {
	ItemBase.ItemRarity.COMMON: 60,      # 60%
	ItemBase.ItemRarity.UNCOMMON: 25,    # 25%
	ItemBase.ItemRarity.EPIC: 12,        # 12%
	ItemBase.ItemRarity.LEGENDARY: 3     # 3%
}

## 精英怪稀有度加成
const ELITE_RARITY_BONUS: Dictionary = {
	ItemBase.ItemRarity.COMMON: -20,
	ItemBase.ItemRarity.UNCOMMON: 10,
...
const BOSS_RARITY_BONUS: Dictionary = {
	ItemBase.ItemRarity.COMMON: -40,
	ItemBase.ItemRarity.UNCOMMON: 0,
	ItemBase.ItemRarity.EPIC: 25,
	ItemBase.ItemRarity.LEGENDARY: 15
}
...
func get_total_drop_rate() -> float:
	...
	@return: 总掉落率
	"""
	return base_drop_chance + bonus_drop_rate + player_luck * luck_drop_modifier
